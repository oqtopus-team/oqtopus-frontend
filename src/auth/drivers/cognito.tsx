...
// This module is only ever loaded by the registry when AUTH_MODE !== 'proxy',
// so `aws-amplify` and the Cognito wiring below are code-split out of proxy
// builds entirely. Configuring Amplify at module load is therefore safe here.
...
export const CognitoAuthProvider: React.FC<React.PropsWithChildren> = ({ children }) => {
