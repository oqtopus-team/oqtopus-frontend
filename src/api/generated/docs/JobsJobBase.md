...
**shots** | **number** | 0 is valid only for newly registered job_ids (job status&#x3D;registered) | [optional] [default to undefined]
...
```typescript
import { JobsJobBase } from './api';

const instance: JobsJobBase = {
    job_id,
    name,
    description,
    job_type,
