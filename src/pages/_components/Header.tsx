...
const Logo = (): React.ReactElement => {
  ...
  const logoSrc = useMemo(() => {
    const headerImageFileNameWithExt =
      import.meta.env.VITE_APP_HEADER_IMAGE_FILENAME ?? 'header-image.png';
    ...
    return `/static_assets/img/common/${headerImageFileName}--${theme === ThemeOptions.DARK ? 'dark' : 'light'}.${headerImageFileNameExt}`;
  }, [theme]);
