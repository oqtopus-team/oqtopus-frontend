import { initQulacsSimulatorModule, QulacsSimulatorAppClient } from 'qulacs-wasm-simulator-client';
...
export const QulacsSimulatorProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
